...
#define DEF_HID_DED_CMD
	...
	__attribute__((aligned(4))) static const uint8_t SetupSetprotocol[] = {0x21, 0x0B, 0x00, 0x00,
																		   0x00, 0x00, 0x00, 0x00};

	/* Set Idle Command Packet */
	__attribute__((aligned(4))) static const uint8_t SetupSetidle[] = {0x21, 0x0A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

	/* Set Report Command Packet */
	__attribute__((aligned(4))) static const uint8_t SetupSetReport[] = {0x21, 0x09, 0x00, 0x02,
																		 0x00, 0x00, 0x01, 0x00};

	/* Get Report Descriptor Command Packet */
	__attribute__((aligned(4))) static const uint8_t SetupGetHidDes[] = {0x81, 0x06, 0x00, 0x22,
																		 0x00, 0x00, 0x00, 0x00};
#endif
