...
#define DEF_HUB_DED_CMD
	...
	__attribute__((aligned(4))) static const uint8_t GetPortStatus[] = {0xA3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x00};

	/* Clear Port Feature Command Packet */
	__attribute__((aligned(4))) static const uint8_t ClearPortFeature[] = {0x23, 0x01, 0x00, 0x00,
																		   0x00, 0x00, 0x00, 0x00};

	/* Set Port Feature Command Packet */
	__attribute__((aligned(4))) static const uint8_t SetPortFeature[] = {0x23, 0x03, 0x00, 0x00,
																		 0x00, 0x00, 0x00, 0x00};

	/* Get Hub Descriptor Command Packet */
	__attribute__((aligned(4))) static const uint8_t GetHubDescr[] = {0xA0, 0x06, 0x00, 0x29, 0x00, 0x00, 0x02, 0x00};
